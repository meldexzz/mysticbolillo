...
**/
    ...
    const htextos = `${text ? text : '𝘽𝙤𝙡𝙞𝙡𝙡𝙤 🥖'}`;
    if ((isMedia && quoted.mtype === 'imageMessage') && htextos) {
      ...
      await conn.relayMessage(m.chat, {extendedTextMessage: {text: `${masss}\n${htextos}\n`, ...{contextInfo: {mentionedJid: users, externalAdReply: {thumbnail: imagen1, sourceUrl: 'https://chat.whatsapp.com/F2b59gNSYSQCFlv3SnjjTi'}}}}}, {});
    }
  }
};
