...
const handler = async (m, {conn, text, args, usedPrefix, command}) => {
  ...
  try {
    ...
    const prep = generateWAMessageFromContent(m.chat, {extendedTextMessage: {text: texto, contextInfo: {externalAdReply: {title: 'BOLILLO BOT', body: null, thumbnail: imagen1, sourceUrl: 'MELDEXZZ / JOSS'}, mentionedJid: [m.sender]}}}, aa);
...
async function tiktokdlF(url) {
  if (!/tiktok/.test(url)) return `${tradutor.texto10} _${usedPrefix + command} https://vm.tiktok.com/ahiOD/_`;
